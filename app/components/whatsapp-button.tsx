...
const PHONE_NUMBER = "60129397686";
...
export default function WhatsAppButton() {
  ...
  const handleQuestionClick = (message: string) => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute bottom-20 right-0 w-80 bg-white rounded-2xl shadow-2xl border border-[var(--cream-dark)] overflow-hidden"
          >
            {/* Header */}
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        animate={isOpen ? {} : { boxShadow: ["0 4px 14px rgba(37,211,102,0.3)", "0 4px 24px rgba(37,211,102,0.5)", "0 4px 14px rgba(37,211,102,0.3)"] }}
